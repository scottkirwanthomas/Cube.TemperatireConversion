...
{
	public class CelsiusToFarenheitStrategy: IConversionStrategy
	{

        public bool CanConvert(Entities.Conversion conversion) => conversion.From.Unit.Equals(ConversionUnit.Celsius) && conversion.To.Unit.Equals(ConversionUnit.Fahrenheit);

        public ServiceResponse CreateResponse(Entities.Conversion conversion)
        {
            conversion.To.Value = (conversion.From.Value * ConversionFactors.CelsiusToFarenheit) + ConversionFactors.FarenheitFactor;
